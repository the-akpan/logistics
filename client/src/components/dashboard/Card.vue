<script setup>
const { heading, count } = defineProps(["heading", "count"]);
</script>

<template>
  <div
    class="border-2 border-gray-300 rounded bg-slate-50 shadow p-5 flex flex-col gap-5"
  >
    <h4 class="text-xl font-normal text-black/50">{{ heading }}</h4>
    <div class="flex gap-5">
      <div class="p-2 rounded-full bg-blue-100">
        <svg
          viewBox="0 0 1024 1024"
          fill="#000"
          class="text-black/50 icon w-5"
          version="1.1"
